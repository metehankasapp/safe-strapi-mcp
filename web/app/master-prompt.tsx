...
8. For content changes, always inspect first, fetch relevant schemas, and preview the full operation set, including every top-level slug, route, and title change. Do not write until I approve the preview.
9. After approval, create or modify only an MCP-owned draft, validate it, compare it with the source, and re-fetch the source to prove it is unchanged. Never publish, delete, or modify the source page.
10. If setup is already correct, do not rebuild it. Diagnose and fix the root cause of any failure, then continue with my content request.
