...
2. Use the local stdio package "safe-strapi-mcp". Do not connect to a hosted /mcp URL and do not ask for an MCP_API_KEY or STRAPI_MCP_TOKEN. Those belong only to optional shared HTTP deployments.
